...
export default function StructuredData() {
  ...
  const organizationSchema = {
    ...
    "description": "Автентични български млечни продукти, създадени по традиционни рецепти. Естествени сирена, кашкавали и кисело мляко от щастливи крави.",
    "sameAs": [
  ...
  const productSchemas = products.map((product) => ({
    ...
    "category": product.id.includes('sirene') ? 'Бяло сирене' : product.id.includes('kashkaval') ? 'Кашкавал' : 'Кисело мляко',
    "offers": {
      "@type": "AggregateOffer",
      "availability": "https://schema.org/InStock",
      "priceCurrency": "BGN"
