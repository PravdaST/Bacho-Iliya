...
export const WEAPON_OPTIONS = [
  {
    value: "сирене",
    label: "Сирене",
    icon: "/products/sirene/BI-sirene-400-metal-480x480.png",
    isImage: true
  },
  {
    value: "кашкавал",
    label: "Кашкавал",
    icon: "/products/kashkaval/BI-kashkaval-1500-480x480.png",
    isImage: true
  },
  {
    value: "кисело мляко",
    label: "Кисело мляко",
    icon: "/products/kiselo-mlqko/BI-kiselo-mlyqko-3.6-480x480.jpg",
    isImage: true
  }
];

export const MOTIVATION_OPTIONS = [
  { value: "за спомените от детството", label: "За спомените от детството" },
  { value: "за здравето на семейството", label: "За здравето на семейството" },
  { value: "защото мразя ментета", label: "Защото мразя ментета" }
];
