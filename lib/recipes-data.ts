...
export const recipes: Recipe[] = [
  {
    ...
    descriptionBg:
      'Автентична българска баница с бяло сирене от Бачо Илия, приготвена по бабината традиционна рецепта предавана от поколения.',
    ...
    instructions: [
      ...
      },
      {
        ...
        stepBg:
          'Разкъсайте на дребно бялото сирене от Бачо Илия в купа. Добавете 3 яйца и киселото мляко от Бачо Илия, разбъркайте добре.',
      },
      {
        ...
        stepBg:
          'Смесете олиото със 100мл вода. Намажете една кора със сместа, нагънете я на гънки и поставете в тавата. Повторете с всички кори.',
      },
      {
      ...
      },
      {
        ...
        stepBg:
          'Разбийте останалото яйце и намажете отгоре. Печете 45 минути докато стане златиста.',
      },
    ],
    tips: [
      {
    ...
    storyBg:
      'Баницата е сърцето на българската кухня. Тази рецепта е усъвършенствана през 30+ години от Бачо Илия, като се използват само естествени съставки. Всяка хапка връща детски спомени от бабината кухня, с автентичния вкус на продуктите на Бачо Илия направени от щастливи крави.',
  },
  {
    ...
    descriptionBg:
      'Емблематичната българска салата покрита с щедро количество настъргано бяло сирене от Бачо Илия - свежа, автентична и неустоимо вкусна.',
    ...
    tips: [
      {
        ...
        tipBg:
          'Тайната е в сиренето - само автентичното бяло сирене от Бачо Илия носи истинския български вкус',
      },
      {
  ...
  },
  {
    ...
    instructions: [
      {
        ...
        stepBg:
          'Обелете и нарежете на ситно краставиците. Поръсете със сол и оставете да се отцеди 10 минути.',
      },
      {
      ...
      },
      {
        ...
        stepBg:
          'Ако използвате, разкъсайте на дребно бялото сирене Бачо Илия и разбъркайте внимателно.',
      },
      {
    ...
    storyBg:
      'Снежанка е обичана българска класика, особено през горещите летни дни. Използването на кисело мляко Бачо Илия - направено от щастливи крави без химия - придава на тази салата автентичния вкус, който познаваха нашите баби. Млечните продукти на Бачо Илия са създадени с над 30 години традиция, носейки детски спомени на вашата трапеза.',
  },
  {
    slug: 'kashkaval-pane',
    ...
    descriptionBg:
      'Хрупкаво отвън, топящо се отвътре - панирано кашкавал Бачо Илия, което връща детски спомени с всяка хапка.',
    ...
    instructions: [
      ...
      },
      {
        ...
        stepBg:
          'Обвалете всяка филийка кашкавал Бачо Илия първо в брашно, после в яйце, после в галета.',
      },
      {
        step: 'Heat oil in a deep pan. Fry kashkaval slices until golden brown on both sides (about 2-3 minutes per side).',
        stepBg:
          'Загрейте олио в дълбока тиган. Пържете филийките кашкавал до златист цвят от двете страни (около 2-3 минути на страна).',
      },
      {
    ...
    tips: [
      {
        ...
        tipBg:
          'Само кашкавалът Бачо Илия се топи перфектно като запазва формата си - това е магията на автентичното българско сирене',
      },
      {
        tip: "Don't make slices too thin - Bacho Ilia kashkaval needs thickness to create that perfect melty center",
        tipBg:
          'Не правете филийките твърде тънки - кашкавалът Бачо Илия се нуждае от дебелина за да създаде перфектна топяща се средина',
      },
      {
    ...
    storyBg:
      'Панираното кашкавал е любимата лакомия на всяко българско дете. Това, което прави тази рецепта специална, е използването на кашкавал Бачо Илия - правен традиционно над 30 години без консерванти, точно както го правеха нашите баби. Автентичният вкус на жълтото сирене Бачо Илия, от щастливи крави, създава незабравимата комбинация от хрупкава кора и кремообразна, топяща се вътрешност, която ви връща направо в детството.',
  },
  {
    ...
    descriptionBg:
      'Върхът на българската бъркана яйца с чушки, домати и щедри парчета топено бяло сирене Бачо Илия - комфортната храна в най-добрия си вид.',
    ...
    instructions: [
      ...
      },
      {
        ...
        stepBg:
          'Добавете нарязаните домати, подправете със сол и пипер. Гответе докато доматите омекнат.',
      },
      {
      ...
      },
      {
        ...
        stepBg:
          'Разбийте яйцата и излейте върху зеленчуците и сиренето Бачо Илия. Разбърквайте докато яйцата се сготвят но са още кремообразни.',
      },
      {
    ...
    tips: [
      {
        ...
        tipBg:
          'Бялото сирене Бачо Илия е задължително - топи се перфектно в яйцата създавайки автентичния български вкус',
      },
      {
        tip: "Don't overcook the eggs - keep them slightly creamy for the best texture with Bacho Ilia cheese",
        tipBg:
          'Не препържвайте яйцата - запазете ги леко кремообразни за най-добра текстура със сиренето Бачо Илия',
      },
      {
        tip: 'Use generous chunks of Bacho Ilia cheese - you want every bite to have that melted cheese goodness',
        tipBg:
          'Използвайте щедри парчета сирене Бачо Илия - искате всяка хапка да има това топено сирене',
      },
    ],
    story:
    ...
    storyBg:
      'Миш-Машът е душата на българската домашна кухня - прост, заситващ и невероятно задоволяващ. Тайната съставка, която вдига това ястие от добро до незабравимо, е бялото сирене Бачо Илия. Направено без химия и консерванти, следвайки рецепти усъвършенствани над 30 години, сиренето Бачо Илия носи автентичния вкус, който познаваха нашите баби. Всяко парче топено бяло сирене Бачо Илия в този миш-маш е вкус на българската традиция, направен от щастливи крави и пълен с детски спомени.',
  },
  {
    ...
    descriptionBg:
      'Крехки чушки пълнени с подправена кайма и ориз, бавно задушени в богат доматен сос. Сервирани с щедра лъжица кисело мляко Бачо Илия - чиста комфортна храна от бабината кухня.',
    ...
    ingredients: [
      { item: '8-10 large bell peppers', itemBg: '8-10 големи чушки' },
      {
        ...
        itemBg: '500г кайма (смес свинско и телешко)',
      },
      ...
      { item: '2 carrots (grated)', itemBg: '2 моркова (настъргани)' },
      {
        ...
        itemBg: '400г консервирани домати или 4 пресни домата (настъргани)',
      },
    ...
    instructions: [
      ...
      },
      {
        ...
        stepBg:
          'В голяма купа смесете каймата, ориза, нарязания на ситно лук, настърганите моркови, нарязания магданоз, червен пипер, сол и черен пипер.',
      },
      {
        step: 'Stuff each pepper with the meat mixture, filling about 3/4 full (rice will expand).',
        stepBg:
          'Напълнете всяка чушка със сместа от кайма, запълвайки около 3/4 (оризът ще набъбне).',
      },
      {
      ...
      },
      {
        ...
        stepBg:
          'Смесете настърганите домати, доматеното пюре и 2 чаши вода. Излейте върху чушките. Добавете сол и червен пипер в соса.',
      },
      {
        step: 'Cover and simmer on low heat for 40 minutes until peppers are tender and rice is fully cooked.',
        stepBg:
          'Покрийте и задушете на тих огън 40 минути докато чушките омекнат и оризът се сготви напълно.',
      },
      {
    ...
    tips: [
      {
        ...
        tipBg:
          'Магическият финал е киселото мляко Бачо Илия - неговият автентичен български вкус и кремообразна текстура перфектно допълват богатия доматен сос',
      },
      {
  ...
  },
  {
    ...
    descriptionBg:
      'Сладка есенна баница с настъргана тиква, орехи, канела и мед. Любима традиция за Бъдни вечер, която изпълва дома с топлина и носталгия.',
    ...
    instructions: [
      {
        ...
        stepBg:
          'Настъргайте тиквата и смесете със захар. Оставете 30 минути да пусне сок, после изстискайте излишната течност.',
      },
      {
      ...
      },
      {
        ...
        stepBg:
          'Намажете една кора със сместа от мляко и масло, сложете 2-3 с.л. плънка от тиква, навийте свободно и наредете в тавата като охлюв. Повторете с останалите кори, нареждайки ги на спирала.',
      },
      {
        step: 'Brush top with remaining milk-butter mixture. Bake for 50 minutes until golden brown.',
        stepBg:
          'Намажете отгоре с останалата смес от мляко и масло. Печете 50 минути докато стане златиста.',
      },
      {
        step: 'While hot, drizzle with honey. Let cool slightly, dust with powdered sugar and serve.',
        stepBg:
          'Докато е още горещ, поливайте с мед. Оставете да изстине леко, поръсете с пудра захар и сервирайте.',
      },
    ],
    tips: [
      {
        ...
        tipBg:
          'Млякото Бачо Илия добавя автентичен български вкус и помага за създаване на перфектната златиста коричка',
      },
      {
        tip: "Don't skip squeezing the pumpkin - excess moisture will make the banitsa soggy",
        tipBg:
          'Не пропускайте изстискването на тиквата - излишната влага ще направи баницата мокра',
      },
      {
  ...
  },
  {
    ...
    descriptionBg:
      'Пластове подправена кайма, нежни картофи и пухкава заливка от кисело мляко Бачо Илия - най-обичаното неделно ястие в всеки български дом. Чист комфорт, който мирише на бабината кухня.',
    ...
    ingredients: [
      {
        ...
        itemBg: '700г кайма (смес свинско и телешко)',
      },
    ...
    instructions: [
      {
        ...
        stepBg:
          'Загрейте 3 с.л. олио в голяма тиган. Запържете нарязания лук до златист цвят, добавете настърганите моркови и гответе 5 минути.',
      },
      {
        ...
        stepBg:
          'Добавете каймата, разбивайки я на парчета. Подправете с червен пипер, сол, черен пипер и чубрица. Гответе докато каймата порумени. Добавете нарязания магданоз.',
      },
      {
      ...
      },
      {
        ...
        stepBg:
          'Наредете половината нарязани картофи в тавата, подправете със сол. Добавете цялата смес от кайма, разпределяйки равномерно. Покрийте с останалите картофи.',
      },
      {
        step: 'In a bowl, whisk together eggs, Bacho Ilia yogurt, flour, and a pinch of salt until smooth.',
        stepBg:
          'В купа разбийте заедно яйцата, киселото мляко Бачо Илия, брашното и щипка сол до гладка смес.',
      },
      {
        step: 'Pour the Bacho Ilia yogurt mixture evenly over the potatoes, ensuring complete coverage.',
        stepBg:
          'Излейте сместа от кисело мляко Бачо Илия равномерно върху картофите, като покриете напълно.',
      },
      {
        step: 'Bake for 50 minutes until the top is golden brown and puffy. Let rest for 10 minutes before serving.',
        stepBg:
          'Печете 50 минути докато отгоре стане златисто и пухкаво. Оставете да почине 10 минути преди сервиране.',
      },
    ],
    tips: [
      {
        ...
        tipBg:
          'Тайната на перфектната мусака е киселото мляко Бачо Илия - то създава характерната пухкава, златиста заливка, която е истински българска',
      },
      {
  ...
  },
  {
    ...
    descriptionBg:
      'Заситяваща зимна яхния от боб с лук, пипер и ароматен доматен сос. Сервирана с щедра лъжица кисело мляко Бачо Илия - топлина и комфорт от селото.',
    ...
    instructions: [
      ...
      },
      {
        ...
        stepBg:
          'Сложете боба в голяма тенджера, покрийте със свежа вода (около 5см над боба). Доведете до кипене, после варете на тих огън 60 минути докато омекне.',
      },
      {
        step: 'In a separate pan, heat oil. Sauté chopped onions until soft, add diced carrots and peppers, cook for 10 minutes.',
        stepBg:
          'В отделна тиган загрейте олио. Запържете нарязания лук докато омекне, добавете нарязаните моркови и чушки, гответе 10 минути.',
      },
      {
      ...
      },
      {
        ...
        stepBg:
          'Добавете зеленчуково-доматената смес към сварения боб. Разбъркайте добре и задушете заедно 30 минути, като бъркате от време на време.',
      },
      {
        step: 'Adjust seasoning. Serve hot in bowls with a generous dollop of Bacho Ilia yogurt on top and fresh bread on the side.',
        stepBg:
          'Пригответе на вкус. Сервирайте горещо в чинии със щедра лъжица кисело мляко Бачо Илия отгоре и пресен хляб отстрани.',
      },
    ],
    tips: [
      {
        ...
        tipBg:
          'Автентичният български щрих е киселото мляко Бачо Илия отгоре - охлажда и балансира заситящата яхния перфектно',
      },
      {
  ...
  },
  {
    ...
    descriptionBg:
      'Проста, но перфектна - пластове точени кори, напоени с мляко Бачо Илия, яйца и масло. Водещата рецепта във всяка българска готварска книга - универсална, заситяваща и винаги вкусна.',
    ...
    instructions: [
      ...
      },
      {
        ...
        stepBg:
          'В голяма купа разбийте заедно яйцата, млякото Бачо Илия, разтопеното масло, олиото и солта (добавете захар ако правите сладък вариант). Разбъркайте до гладкост.',
      },
      {
      ...
      },
      {
        ...
        stepBg:
          'Наредете 2-3 кори на дъното на тавата, като ги намачкате леко. Излейте част от сместа с мляко Бачо Илия върху тях. Повторете пластовете докато свършат корите, завършвайки с млечна смес отгоре.',
      },
      {
        step: 'Make sure all filo sheets are well soaked with the Bacho Ilia milk mixture. Let stand for 10 minutes before baking.',
        stepBg:
          'Уверете се, че всички кори са добре напоени със сместа от мляко Бачо Илия. Оставете да престои 10 минути преди печене.',
      },
      {
      ...
      },
      {
        ...
        stepBg:
          'Оставете да изстине 10 минути преди рязане. Сервирайте топла или студена - и в двата случая е вкусна!',
      },
    ],
    tips: [
      {
        ...
        tipBg:
          'Млякото Бачо Илия е душата на тази баница - неговият автентичен вкус и качество правят цялата разлика',
      },
      {
        tip: 'For a savory version, omit sugar and serve with yogurt. For sweet version, add sugar and dust with powdered sugar',
        tipBg:
          'За солен вариант, не слагайте захар и сервирайте с кисело мляко. За сладък вариант добавете захар и поръсете с пудра захар',
      },
      {
  ...
  },
  {
    ...
    descriptionBg:
      'НАЙ-популярното българско ястие - сочни пържени кюфтета подправени с кимион, чесън и чубрица. Сервирани с кисело мляко Бачо Илия, пресна салата и лютеница. Рай!',
    ...
    instructions: [
      {
        ...
        stepBg:
          'Изстискайте излишната вода от накиснатия хляб. В голяма купа смесете каймата, хляба, яйцето, нарязания лук, нарязания чесън, кимиона, чубрицата, червения пипер, содата, сол и черен пипер.',
      },
      {
      ...
      },
      {
        ...
        stepBg:
          'Загрейте олио в дълбока тиган (около 2см дълбочина). Пържете кюфтетата на партиди, обръщайки за да порумени равномерно от всички страни, около 4-5 минути партида.',
      },
      {
        step: 'Drain on paper towels. Serve hot with generous dollops of Bacho Ilia yogurt, fresh green salad, and lyutenitsa.',
        stepBg:
          'Отцедете на хартия. Сервирайте горещо със щедри лъжици кисело мляко Бачо Илия, пресна зелена салата и лютеница.',
      },
    ],
    tips: [
      {
        ...
        tipBg:
          'Автентичният български начин е с кисело мляко Бачо Илия - студеният му, кисел вкус перфектно балансира горещите, подправени кюфтета',
      },
      {
