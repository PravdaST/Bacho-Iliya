...
export const products: Product[] = [
  {
    ...
    category: 'cheese',
    shortDescription:
      'Традиционно българско бяло сирене, направено по бабината рецепта от краве мляко.',
    fullDescription:
      'Нашето бяло сирене е направено точно както бабата ме научи преди 50 години. Само прясно краве мляко от щастливи крави на свободен избор, сол и култура. Без консерванти, без химия, без бързане. Узрява минимум 30 дни за да получи истинския плътен вкус на традиционното българско сирене.',
    ...
    ingredients: ['Пастьоризирано краве мляко', 'Сол', 'Млечнокисели култури', 'Сирищен фермент'],
    nutritionPer100g: {
    ...
    bachoTip:
      'Сиренето трябва да е едро счукано за баница, не на ситно. Така хапва по-хубаво и вкусът излиза по-добре.',
    testimonials: [
      {
        name: 'Мария',
        location: 'София',
        quote:
          'Децата ми отказваха всяко сирене... 5-годишната ми дъщеря сега иска само Бачо Илия!',
        rating: 5,
      },
      {
        name: 'Иван',
        location: 'Пловдив',
        quote:
          'От години търсех вкуса на бабините сирена... Пробвах Бачо Илия и плаках като малко дете.',
        rating: 5,
      },
      {
        name: 'Елена',
  ...
  },
  {
    ...
    fullDescription:
      'Кашкавалът е направен по същата бабина рецепта, но с повече търпение. Узрява 60 дни за да получи характерния си златист цвят и кремава текстура. Топи се красиво и е перфектен за панирано кашкавал, пици или просто като закуска. Децата го обичат, родителите му се доверяват.',
    ...
    bachoTip:
      'Кашкавалът се топи красиво ако го изважиш 10 минути преди готвене от хладилника. Сервирай го топло - по-добре от ресторантско.',
    testimonials: [
      {
        name: 'Георги',
        location: 'Бургас',
        quote:
          'Синът ми е на 8 години и ми каза "тате, този кашкавал е по-добър от пицата в центъра". Повече не мога да кажа.',
        rating: 5,
      },
      {
        name: 'Десислава',
        location: 'Русе',
        quote:
          'Правя панирано кашкавал всяка неделя с Бачо Илия. Всеки път ядем до последното парченце.',
        rating: 5,
      },
    ],
    features: [
    ...
    storage:
      'Съхранявайте на температура от 2°C до 8°C. След отваряне консумирайте в рамките на 7 дни.',
  },
  {
    id: 'kiselo-mlyako-2',
    name: 'Кисело мляко 2%',
    ...
    fullDescription:
      'Кисело мляко 2% мазнини - перфектният баланс между здравословно хранене и традиционен вкус. Правим го всеки ден от прясно краве мляко и жива култура. Гъсто, с корица отгоре, с истински вкус на село. Идеално за хора които пазят линията, но не искат да жертват вкуса.',
    image: '/products/kiselo-mlqko/BI-kiselo-mlyqko-2-480x480.jpg',
    sizes: [{ size: 'Стандартна', weight: '400г' }],
    ingredients: [
    ...
    bachoTip:
      'Това кисело мляко е нискомаслено, но пак гъсто! Перфектно за таратор и снежанка - кремава текстура, без излишни калории.',
    testimonials: [
      {
        name: 'Надежда',
        location: 'София',
        quote:
          'Най-доброто кисело мляко което съм яла след бабиното. Истинско, гъсто, с корица отгоре.',
        rating: 5,
      },
      {
        name: 'Петър',
  ...
  },
  {
    ...
    fullDescription:
      'Кисело мляко 3.6% мазнини - това е класиката! Най-популярният вариант в България. Не е много мазно, не е много лайт - точно както трябва да бъде истинското българско кисело мляко. Гъсто, с корица, с бабиния вкус на село. Перфектно за таратор, снежанка или просто така с мед.',
    ...
    relatedRecipes: ['snezhanka-tarator-combo'],
    bachoTip:
      'Това е "златната среда" - ако не знаеш кое да избереш, вземи 3.6%. То е класиката, която всички обичаме от дете.',
    testimonials: [
      {
        name: 'Петър',
        location: 'Велико Търново',
      ...
      },
      {
        ...
        location: 'Пловдив',
        quote:
          'Децата ми ядат това кисело мляко с лъжица и викат "още!". Първият път да видя това!',
        rating: 5,
      },
    ],
    features: [
  ...
  },
  {
    ...
    fullDescription:
      'Кисело мляко 4.5% мазнини - това е "Rolls-Royce"-ът на киселите млека! Най-пълномасленото, най-кремавото, с най-наситен вкус. Ако искаш истинско село кисело мляко като на бабата, това е то. Топи се на езика, гъсто като крем, с богат млечен вкус. За истинските гурмани.',
    ...
    relatedRecipes: ['snezhanka-tarator-combo'],
    bachoTip:
      'Пълномасленото кисело мляко е тайната за перфектна снежанка - излиза като крем, копринена, като на ресторант!',
    testimonials: [
      {
        name: 'Надежда',
        location: 'София',
      ...
      },
      {
        ...
        location: 'Варна',
        quote:
          'Ям го с лъжица като десерт. Жена ми казва "то е кисело мляко, не сладолед!" Ама е толкова добро...',
        rating: 5,
      },
    ],
    features: [
  ...
  },
  {
    ...
    fullDescription:
      'Айранът на Бачо Илия е направен както бабата ме научи - от прясно кисело мляко, вода и щипка сол. Без консерванти, без стабилизатори, без добавки. Просто истински айран който утолява жаждата и освежава в горещите летни дни. Перфектен с баница, с мусака или просто така когато си изморен.',
    ...
    ingredients: ['Кисело мляко (краве мляко, млечнокисели култури)', 'Вода', 'Сол'],
    nutritionPer100g: {
    ...
    relatedRecipes: [],
    bachoTip:
      'Айранът е най-добър студен, но не ледено студен! На 8-10 градуса е перфектен - утолява жаждата без да те наръби.',
    testimonials: [
      {
        name: 'Георги',
        location: 'Пловдив',
  ...
  },
  {
    ...
    relatedRecipes: [],
    bachoTip:
      'След тренировка ядеш ли протеиново кисело мляко? Мускулите ти ще благодарят! 40г протеин в 1 опаковка, естествено от мляко.',
    testimonials: [
      {
        name: 'Атанас',
        location: 'София',
        quote:
          'Преди плащах 10 лева за протеинов шейк с химия. Сега ям кисело мляко на Бачо Илия за 3 лева и е по-добро!',
        rating: 5,
      },
      {
        name: 'Мартин',
        location: 'Варна',
        quote:
          'Качвам мускулна маса с протеиново кисело мляко. Вкусът е страхотен, протеините са реални!',
        rating: 5,
      },
    ],
    features: [
