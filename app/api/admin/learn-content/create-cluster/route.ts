...
function getSuggestedPillars(category: string, clusterTitle: string): string[] {
  const suggestions: Record<string, string[]> = {
    'recipes-yogurt': [
      ...
      'Тиквички с кисело мляко на фурна',
      'Кекс с кисело мляко',
      'Катми с кисело мляко',
      'Айрян - как се прави перфектният айрян'
    ],
    'recipes-cheese': [
      'Класическа баница със сирене',
    ...
    health: [
      ...
      'Калций в млечните продукти за здрави кости',
      'Киселото мляко в храненето на деца',
      'Пробиотици и чревно здраве - научни факти'
    ],
    culture: [
      'История на киселото мляко в България',
      'Традиционно българско производство на сирене',
      'Откъде идва качественото мляко: Ролята на пасищата',
      'Българските млечни традиции и обичаи',
      'Киселото мляко в българския фолклор',
      'Местно производство срещу индустриално'
    ],
    products: [
      'Как се прави истинско българско кисело мляко',
      'Разлика между кисело мляко, айрян и катък',
      'Видове българско сирене: Краве, овче, козе',
      'Правилно съхранение на млечни продукти',
      'Как да изберем качествено кисело мляко в магазина',
      'Без консерванти в млечните продукти - защо е важно'
    ],
    tradition: [
      'Киселото мляко на българската трапеза през вековете',
      'Млечните продукти по време на български празници',
      'Стари български обичаи, свързани с млякото',
      'Рецепти от тефтера на баба: Млечни ястия',
      'Традиционни методи за подсирване на сирене'
    ],
  ...
  if (category === 'recipes') {
    if (clusterTitle.toLowerCase().includes('сирене')) {
      return suggestions['recipes-cheese'];
    }
    if (clusterTitle.toLowerCase().includes('кисело мляко')) {
...
→ ["Таратор - класическата рецепта", "Млечна баница стъпка по стъпка", "Снежанка (салата с цедено кисело мляко, краставици, чесън и копър)", "Айрян - българската лятна напитка"]
...
ПРАВИЛА ЗА LINKING:
- Добави 3-5 product линка естествено в текста
- Добави 2-3 recipe линка където е релевантно
