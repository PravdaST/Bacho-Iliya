      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-12 h-12 bg-traditional-red rounded-full flex items-center justify-center">
              <span className="text-cream font-playfair font-bold text-lg">БИ</span>
            </div>
            <span className="text-cream font-playfair font-semibold text-xl">Бачо Илия</span>
          </div>
